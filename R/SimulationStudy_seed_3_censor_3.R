...
setwd("C:/Users/yinliao/OneDrive - Texas Tech University/Research/Prognosis Analysis - Cancer/Codes/Ying/Matlab/IISE-Revision-1/results/SimulationStudy/seed_3/censor_3")
...
#---------------------- Figure Parameters -------------------------------#
#tiff("clustering_seed_3_censor_3.tif", width = 8.4, height = 2.6, units = 'in', res = 300)
png("clustering_seed_3_censor_3.png", width = 8.4, height = 2.6, units = 'in', res = 300)
