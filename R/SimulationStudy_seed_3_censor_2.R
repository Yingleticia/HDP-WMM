...
setwd("C:/Users/yinliao/OneDrive - Texas Tech University/Research/Prognosis Analysis - Cancer/Codes/Ying/Matlab/IISE-Revision-1/results/SimulationStudy/seed_3/censor_2")
...
#---------------------- Figure Parameters -------------------------------#
#tiff("clustering.tif", width = 8.4, height = 2.6, units = 'in', res = 300)
png("clustering.png", width = 8.4, height = 2.6, units = 'in', res = 300)
