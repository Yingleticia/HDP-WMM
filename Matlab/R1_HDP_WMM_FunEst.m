function [FunEstAll,FunEstAll_more,xx,X_upper,KM_sur] = ...
    R1_HDP_WMM_FunEst(SurvivalFlag,data_record,gamma_record,alpha_0_record,...
...
if strcmp(SurvivalFlag,'Overall')
    filename = [folder,'Overall_ClusterDraws_HDP_WMM.xlsx'];
elseif strcmp(SurvivalFlag,'Specific')
    filename = [folder,'Specific_ClusterDraws_HDP_WMM.xlsx'];
end
